...
target "package-python" {
	...
	tags = ["docker.io/aswftesting/ci-package-python:2020"]
}

target "package-boost" {
	target = "ci-base-boost-package"
	inherits = ["settings", "settings-2020"]
	tags = ["docker.io/aswftesting/ci-package-boost:2020"]
}

target "package-tbb" {
	target = "ci-base-tbb-package"
	inherits = ["settings", "settings-2020"]
	tags = ["docker.io/aswftesting/ci-package-tbb:2020"]
}

target "package-cppunit" {
	target = "ci-base-cppunit-package"
	inherits = ["settings", "settings-2020"]
	tags = ["docker.io/aswftesting/ci-package-cppunit:2020"]
}

target "package-glew" {
	target = "ci-base-glew-package"
	inherits = ["settings", "settings-2020"]
	tags = ["docker.io/aswftesting/ci-package-glew:2020"]
}

target "package-glfw" {
	target = "ci-base-glfw-package"
	inherits = ["settings", "settings-2020"]
	tags = ["docker.io/aswftesting/ci-package-glfw:2020"]
}

target "package-log4cplus" {
	target = "ci-base-log4cplus-package"
	inherits = ["settings", "settings-2020"]
	tags = ["docker.io/aswftesting/ci-package-log4cplus:2020"]
}
