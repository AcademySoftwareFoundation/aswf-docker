...
#
# From: https://github.com/conan-io/conan-center-index/blob/5d3d03d17ad9f83e87f8cfc3b6a701352bb517cc/recipes/openjph/all/conanfile.py
...
class OpenJPH(ConanFile):
    ...
    def package(self):
        ...
        # rmdir(self, os.path.join(self.package_folder, "lib", "cmake")) # ASWF
