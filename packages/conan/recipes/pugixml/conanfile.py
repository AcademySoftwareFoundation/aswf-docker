...
#
# From:  https://github.com/conan-io/conan-center-index/blob/f83ca9df2f14d01f49b186cb279740c295ae09c9/recipes/pugixml/all/conanfile.py
...
class PugiXmlConan(ConanFile):
    ...
    def package(self):
        ...
        # ASWF: license in package sbudir
        save(self, os.path.join(self.package_folder, "licenses", self.name, "LICENSE"), license_contents)
        if self.options.header_only:
