...
class CMakeConan(ConanFile):
    ...
    def requirements(self):
        ...
        self.requires("zlib/[>=1.2.11 <2]")  # ASWF: zlib is built in common-1 ahead of cmake
    ...
    def generate(self):
        if self.options.bootstrap:
            ...
            tc.cache_variables["CMAKE_USE_SYSTEM_ZLIB"] = True  # ASWF: use Conan zlib from common-1
            tc.generate()
            tc = CMakeDeps(self)
