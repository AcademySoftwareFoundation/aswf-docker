...
#
# From: https://github.com/conan-io/conan-center-index/blob/5b17b876f2b6899f3cc8dbfb2282b361cd18a48a/recipes/hdf5/all/conanfile.py
...
class Hdf5Conan(ConanFile):
    ...
    def package(self):
        # ASWF: license file in packace subdir
