...
#
# From: https://github.com/conan-io/conan-center-index/blob/feef5a8b9d03692bf27a8e1e94a6f59fd493d420/recipes/cimg/all/conanfile.py
...
class CImgConan(ConanFile):
    ...
    def package(self):
        # ASWF: licenses in package specific directory
        copy(self, "Licence*", src=self.source_folder, dst=os.path.join(self.package_folder, "licenses", self.name))
