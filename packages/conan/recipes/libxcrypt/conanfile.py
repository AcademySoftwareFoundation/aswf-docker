...
#
# From: https://github.com/conan-io/conan-center-index/blob/6aeda9d870a1253535297cb50b01bebfc8c62910/recipes/libxcrypt/all/conanfile.py
...
class LibxcryptConan(ConanFile):
    ...
    def package(self):
        ...
        copy(self, "COPYING.LIB", src=self.source_folder, dst=os.path.join(self.package_folder, "licenses", self.name))
        autotools = Autotools(self)
