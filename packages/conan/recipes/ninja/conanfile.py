...
#
# From: https://github.com/conan-io/conan-center-index/blob/5aa8fda35e023ceeaefb5a670ae9c0c3ca4fdf25/recipes/ninja/all/conanfile.py
...
class NinjaConan(ConanFile):
    ...
    def package(self):
        # ASWF: license files in per package folder
