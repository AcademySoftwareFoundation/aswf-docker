...
FROM ${ASWF_ORG}/ci-common:${CI_COMMON_VERSION}-clang${ASWF_CLANG_MAJOR_VERSION} as ci-materialx
...
LABEL org.opencontainers.image.name="$ASWF_ORG/ci-materialx"
LABEL org.opencontainers.image.title="MaterialX CI Docker Image"
LABEL org.opencontainers.image.description="Contains: Python, Boost and other MaterialX upstream dependencies\
...
LABEL org.opencontainers.image.source="https://github.com/AcademySoftwareFoundation/aswf-docker/blob/master/ci-materialx/Dockerfile"
...
COPY ci-materialx/README.md ci-materialx/image.yaml /usr/local/aswf/
